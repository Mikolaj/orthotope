...
ceiling](../README.md#the-mutable-ceiling-taken)). The roster is Run 16's: 1128
benches, 47 timed arms over 24 shapes, every stride class at three, unchanged
since Run 15. The allocation area is fixed at `-A32m` and no pair will vary
it again: Runs 14, 15 and 16 priced it, the decision of 2026-08-21 closed it,
and the 24m/48m probe that could have reopened it was taken ahead of Run 17
